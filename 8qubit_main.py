...
model, qubits, thetas = blocks.peps_8_online_full_a()
...
#buildDataFromIris()
# Reading in the data
data = genfromtxt('sudoku_shuffled_train.csv',delimiter=',')  # Training data
test_data = genfromtxt('sudoku_shuffled_test.csv',delimiter=',')  # Test data
